...
namespace XMLParsing
{
    public class XmlValidatorTestHelper
    {
        ...
        public bool ValidXmlDoc(XmlDocument xmlDocument, XmlSchema xmlSchema)
        {
            try
            {
                XmlTextReader reader = new XmlTextReader(@"C:\Users\Priyanka\Downloads\XMLParserConsoleTester\XMLParserConsoleTester\XMLParsing_UTest\XMLJobSchema.xsd"); // Change in filepath as to where schema is stored in the user's PC
